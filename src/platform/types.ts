...
export function safeExternalUrl(value:string){const u=new URL(value,typeof location==='undefined'?'https://localhost.invalid':location.origin);if(!SAFE_SCHEMES.has(u.protocol))throw new Error('Unsafe external navigation');return u.toString();}
