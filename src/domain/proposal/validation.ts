...
if(o.r1Quality!=='Ready for sizing')error('r1-not-ready',`R1 consumption is ${o.r1Quality}.`);
...
if(o.r3Issues.some(i=>i.severity==='error'))error('r3-electrical-errors','R3 electrical design has blocking errors.');
if(!(o.r3Summary.annualProductionKwh>0))error('r3-no-production','R3 annual production output is missing or invalid.');
if(o.r4Economics.readiness!=='Ready')error('r4-not-ready',`R4 economics readiness is ${o.r4Economics.readiness}.`);
